...
/****** Object:  View [dbo].[ParliamentMembers]    Script Date: 26.11.2015 17:04:55 ******/
SET ANSI_NULLS ON
GO
...
create View [dbo].[ParliamentMembers_Test] (Election_Id, FirstName, LastName, HowCome, State, Party) as 
...
select votes.Election_Id as Election_Id, votes.Bundesland_Id as Bundesland_Id, votes.party_Id as Party_Id, 
	round(1.0*votes.Amount/dbo.divisorParty_test(votes.Election_Id, votes.Party_ID, s.SeatsParty),0)  as seats
